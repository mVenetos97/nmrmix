...
class QChem_NMR(QCOutput):
    """
    Class to parse QChem output files for NMR data.
    """
    ...
    def _molecular_graph(self):
        mol_graph = MoleculeGraph(self.data['initial_structure'])
        return mol_graph
...
def from_QCHEM(file_path):
    data = QChem_NMR(file_path)
